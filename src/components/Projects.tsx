...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Case study for a smart-city dashboard delivering real-time environmental data — weather, air quality, noise — through a glanceable widget-based mobile interface.",
  ...
  {
    index: "06",
    title: "Bookify Travel App",
    client: "Concept",
    year: "2024",
    category: "UI/UX · Mobile",
    description:
      "Concept for a travel booking app with a seamless search-to-booking flow, curated deals, and interactive stay previews — designed to reduce decision fatigue.",
    technologies: ["React Native", "TypeScript", "Mapbox"],
    ...
    >
      ...
      >
        <Image
          ...
          style={{
            objectFit: "cover",
            filter: hovered ? "contrast(1) saturate(1)" : "contrast(1.02) saturate(0.85)",
...
const s: Record<string, React.CSSProperties> = {
  ...
  body: { padding: "24px 24px 28px", display: "flex", flexDirection: "column" as const, gap: 10, flex: 1 },
  metaRow: {
    display: "flex",
    alignItems: "center",
    gap: 10,
